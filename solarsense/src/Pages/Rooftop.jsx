...
// import './App.css';
import MapRT from '../Components/MapRT';
import { Link } from 'react-router-dom';
// import MapRT2 from '../Components/MapRT2';
  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-800 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 text-white dark:border-gray-700">
        <Link to='/'>
        <li>
          <a href="#" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" aria-current="page">Home</a>
        </li>
        </Link>
        <Link to='/rooftop'>
        <li>
          <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500">Rooftop</a>
        </li>
        </Link>
        <Link to='/yield'>
        <li>
...
<div class="container px-20 pt-10 mx-auto   h-full w-full   dark:bg-dot-white/[0.2] bg-dot-lime-300/[0.4] ">

<div class="container   mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                <h1 className='text-7xl font-sans font-bold	text-lime-300 bg-clip-text text-transparent bg-gradient-to-b from-lime-200 to-lime-500'>Roof Top Analysis</h1>
